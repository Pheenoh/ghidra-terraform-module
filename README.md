...
## Spot Instances w/ Custom Instance Types
```
use_spot = true
...
| [aws_spot_fleet_request.default](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/spot_fleet_request) | resource |
...
| <a name="input_use_spot"></a> [use\_spot](#input\_use\_spot) | Whether or not to host Ghidra on a spot instance. | `bool` | `true` | no |
